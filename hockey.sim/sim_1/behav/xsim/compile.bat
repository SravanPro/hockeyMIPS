...
REM
REM Generated by Vivado on Tue May 26 22:01:33 +0530 2026
...
echo "xvlog --incr --relax -prj hockeyTB_vlog.prj"
call xvlog  --incr --relax -prj hockeyTB_vlog.prj -log xvlog.log
